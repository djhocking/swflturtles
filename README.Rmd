...
You can download the compendium as a zip from from this URL: <https://github.com/djhocking/swflturtles/archive/master.zip>

Or you can install this compendium as an R package, swflturtles, from GitHub with:
