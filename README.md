...
<https://github.com/djhocking/swflturtles/archive/master.zip>

Or you can install this compendium as an R package, swflturtles, from
GitHub with:

``` r
# install.packages("devtools")
remotes::install_github("djhocking/swflturtles")
```
